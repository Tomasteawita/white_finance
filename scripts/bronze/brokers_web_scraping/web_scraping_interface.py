...
class WebScrapingInterface:
    """
        ...
        - BRONZE_DATA_PATH: Source data path
    ...
    def __init__(self, **kwargs):
        ...
        self.BRONZE_DATA_PATH = getenv("BRONZE_DATA_PATH")
        ...
        while True:
            ...
            match action:
                case "1":
                    ...
                    broker_instance.get_portfolio(self.webdriver, self.BRONZE_DATA_PATH, extract_date)
                case "2":
                    break
                case _:
